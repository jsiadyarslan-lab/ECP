...
from ecp.gemini_conformance import build_gemini_conformance_gateway
...
gateway = build_gemini_conformance_gateway(
    config,
    model=os.environ.get("ECP_GEMINI_MODEL", "gemini-3.8-flash"),
)
