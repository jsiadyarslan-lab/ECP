...
from ecp.openrouter_conformance import build_openrouter_conformance_gateway
...
gateway = build_openrouter_conformance_gateway(
    config,
    model=os.environ.get("ECP_OPENROUTER_MODEL", "openrouter/free"),
)
...
console_server = ThreadingHTTPServer(("127.0.0.1", CONSOLE_PORT), SimpleHTTPRequestHandler)
try:
